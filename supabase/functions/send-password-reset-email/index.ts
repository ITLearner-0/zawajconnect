...
<p class="message">Nous avons reçu une demande de réinitialisation de mot de passe pour votre compte Zawaj Connect. Pas d'inquiétude, c'est un processus simple et sécurisé ! 🔒</p>
<p class="message">Pour créer votre nouveau mot de passe, il vous suffit de cliquer sur le bouton ci-dessous :</p>
<div class="cta-container">
<a href="${resetLink}" class="cta-button">Réinitialiser mon mot de passe</a>
</div>
<div class="info-box">
<div class="info-box-title">Validité du lien</div>
<div class="info-box-text">Ce lien est valide pendant <strong>1 heure</strong> pour des raisons de sécurité. Après ce délai, vous devrez faire une nouvelle demande.</div>
</div>
<div class="security-box">
<div class="security-box-title">Vous n'avez pas fait cette demande ?</div>
<div class="security-box-text">Si vous n'êtes pas à l'origine de cette demande, vous pouvez ignorer cet email en toute sécurité. Votre mot de passe actuel restera inchangé et votre compte est protégé. 🛡️</div>
</div>
...
<p class="message" style="margin-top: 30px; font-size: 14px; color: #6b7280;">Qu'Allah facilite votre parcours et vous guide vers une union bénie. 🤲</p>
</div>
<div class="footer">
<div class="footer-brand">Zawaj Connect</div>
<div class="footer-tagline">"Construire des unions halal avec confiance"</div>
<div class="footer-text">Cet email a été envoyé à <span class="footer-email">${email}</span><br>dans le cadre d'une demande de réinitialisation de mot de passe.</div>
<div class="footer-text" style="margin-top: 15px;">© 2025 Zawaj Connect. Tous droits réservés.<br>Une plateforme de rencontres islamiques respectueuse et sécurisée.</div>
</div>
</div>
</body>
</html>`;
