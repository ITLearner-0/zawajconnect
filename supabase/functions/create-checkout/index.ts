...
serve(async (req) => {
  ...
  try {
    ...
    const planPricing = {
      premium: { amount: 999, name: "Premium - Recherche Avancée" }, // €9.99
      vip: { amount: 1999, name: "VIP - Accès Complet + Conseiller" } // €19.99
    };
          ...
          price_data: {
            ...
            product_data: { 
              ...
              description: plan === "vip" 
                ? "Accès complet + conseiller matrimonial + profil vérifié" 
                : "Recherche avancée + messages illimités + filtres détaillés"
            },
