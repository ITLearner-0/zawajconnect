-- Fix: Update handle_new_user_complete to use NULL instead of 'non_specifie' for gender
-- This fixes the signup error caused by profiles_gender_check constraint
...
BEGIN
  ...
  -- Create profile (MUST succeed) with NULL gender to pass CHECK constraint
  INSERT INTO public.profiles (
    ...
    default_full_name,
    25, -- default age
    NULL, -- Changed from 'non_specifie' to NULL to pass profiles_gender_check
    'Non spécifié',
    NOW(),
    NOW()
  )
