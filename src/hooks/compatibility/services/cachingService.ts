...
interface UserResultsCache {
  [userId: string]: CacheItem<{ answers: Record<string, any>; preferences: any }>;
}
...
class MemoryCache {
  ...
  setUserResults(userId: string, data: { answers: Record<string, any>; preferences: any }): void {
...
export const compatibilityCache = new MemoryCache();
