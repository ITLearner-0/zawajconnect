...
export const matrimonialFaqs: FaqItem[] = [
  {
    ...
    answer: "Les fiançailles islamiques (khitbah) sont une promesse de mariage qui peut être rompue sans procédure légale. Le mariage islamique (nikah) est un contrat religieux qui nécessite des témoins, un tuteur (wali) pour la femme, et un mahr (dot). Le mariage civil est la reconnaissance légale par l'État.\n\nEn Islam, le nikah est considéré comme le vrai mariage, même s'il doit être accompagné du mariage civil pour être reconnu légalement dans de nombreux pays.",
  ...
  },
  {
    ...
    answer: "Il n'y a pas de montant fixe pour le mahr en Islam. Le Prophète ﷺ a dit : 'Le meilleur mahr est le plus facile.' L'important est que le montant soit raisonnable et que les deux parties soient d'accord.\n\nLe mahr peut être :\n- De l'argent\n- Des bijoux\n- Des biens immobiliers\n- Même l'enseignement du Coran (comme dans le cas du Prophète avec Safiyya)\n\nIl faut éviter les excès qui peuvent créer des difficultés financières ou des discriminations sociales.",
    category: "marriage-contract",
...
export const courtshipGuides = [
  {
    ...
    description: "Tout ce que vous devez savoir sur les fiançailles en Islam, de la demande aux préparatifs du mariage.",
    category: "courtship",
    author: "Dr. Yasir Qadhi",
    contentType: "guide" as const,
    difficulty: "beginner" as const,
    readingTime: 45,
    content: "Ce guide complet vous accompagne à travers toutes les étapes des fiançailles islamiques...",
  ...
  },
  {
    ...
    description: "Apprendre à communiquer efficacement et respectueusement avec son/sa futur(e) époux/épouse.",
    category: "communication",
    author: "Ustadha Zaynab Ansari",
    contentType: "guide" as const,
    difficulty: "intermediate" as const,
    readingTime: 30,
    content: "La communication est la clé d'un mariage réussi. Ce guide explore les principes islamiques...",
  ...
  },
  {
    ...
    description: "Guide pour naviguer les dynamiques familiales et impliquer les deux familles de manière harmonieuse.",
    category: "family",
    author: "Sheikh Hamza Yusuf",
    contentType: "guide" as const,
    difficulty: "advanced" as const,
    readingTime: 60,
    content: "L'implication des familles est cruciale dans le mariage islamique. Ce guide avancé...",
