...
export const islamicResources: IslamicResource[] = [
  ...
  },
  {
    ...
    description: "Conseils pratiques sur les compétences de communication basées sur les principes islamiques.",
    category: "communication",
    author: "Sr. Yasmin Mogahed",
    contentType: "guide",
    content: "La communication est le fondement d'un mariage réussi. Le Prophète Muhammad (paix sur lui) était le meilleur exemple de communication efficace avec ses épouses. Il écoutait attentivement, parlait avec bonté et n'élevait jamais la voix par colère...",
    imageUrl: "/placeholder.svg",
  ...
  },
  {
    ...
    description: "Directives islamiques sur la gestion des finances dans le mariage et éviter les pièges courants.",
    category: "marriage-prep",
  ...
  },
  {
    ...
    contentType: "article",
    content: "La nuit de noces est un moment spécial dans la vie d'un couple. L'Islam fournit de beaux conseils pour s'assurer que cette expérience intime soit confortable et bénie. Commencez au nom d'Allah, offrez un repas léger, priez deux rakats ensemble, et faites des invocations pour la bénédiction de votre union...",
    imageUrl: "/placeholder.svg",
  ...
  },
  {
    ...
    description: "Apprenez comment le Prophète Muhammad (PSL) résolvait les conflits avec ses épouses.",
    category: "communication",
  ...
  },
  {
    ...
    description: "Perspective islamique sur ce qui rend les couples vraiment compatibles pour un mariage durable.",
    category: "compatibility",
    author: "Dr. Mohammad Akram Nadwi",
    contentType: "article",
    content: "La compatibilité dans le mariage va au-delà de l'attraction physique ou du statut social. Le Prophète Muhammad (paix sur lui) a souligné le kafa'ah (compatibilité) en termes d'engagement religieux, de caractère et de valeurs. Cet article explore comment évaluer la compatibilité d'un point de vue islamique...",
    imageUrl: "/placeholder.svg",
  ...
  },
  {
    ...
    contentType: "guide",
    content: "Le wali (tuteur) joue un rôle crucial dans les mariages islamiques, particulièrement pour les femmes. Ce guide explique les qualifications d'un wali, leurs responsabilités, et la sagesse derrière cette exigence dans la loi islamique...",
    imageUrl: "/placeholder.svg",
  ...
  },
  {
    ...
    description: "L'importance du conseil avant le mariage et comment il s'aligne avec les valeurs islamiques de préparation et de compatibilité.",
    category: "compatibility",
  ...
  },
  {
    ...
    description: "Comprendre l'intimité physique et émotionnelle dans les limites halal du mariage.",
    category: "marriage-prep",
