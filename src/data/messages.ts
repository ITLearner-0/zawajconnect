...
export const dummyMessages: Record<string, Message[]> = {
  'conv-1': [
    ...
    },
    {
      ...
      sender_id: 'current-user',
      content:
        'I work in technology and am passionate about community service. I enjoy hiking and reading in my spare time.',
  ...
  'conv-2': [
    {
      ...
      sender_id: 'user-2',
      content:
        'Assalamu alaikum! I read your profile and was impressed by your commitment to Islamic values.',
    ...
    },
    {
      ...
      sender_id: 'current-user',
      content:
        "Walaikum assalam! Thank you, I believe that's essential in finding a compatible spouse.",
    ...
    },
    {
      ...
      sender_id: 'user-2',
      content:
        'For me, I value someone who prioritizes their deen, is kind, and has good family values.',
  ...
  'conv-3': [
    {
      ...
      sender_id: 'current-user',
      content:
        "Assalamu alaikum! I noticed you're a doctor. I have a lot of respect for healthcare professionals.",
    ...
    },
    {
      ...
      sender_id: 'user-3',
      content:
        "Walaikum assalam! Thank you. It's challenging but rewarding work. What field are you in?",
    ...
    },
    {
      ...
      sender_id: 'current-user',
      content:
        "I work in education. I'm interested in how you balance your busy career with religious practices.",
    ...
    },
    {
      ...
      sender_id: 'user-3',
      content:
        "It's all about time management and prioritization. I find that my faith actually helps me be more focused and compassionate in my work.",
  ...
  'conv-4': [
    {
      ...
      sender_id: 'user-4',
      content:
        'Assalamu alaikum! I enjoyed reading your profile and would like to get to know you better.',
    ...
    },
    {
      ...
      sender_id: 'current-user',
      content:
        "Walaikum assalam! Thank you for reaching out. I'd be happy to chat and see if we might be compatible.",
    ...
    },
    {
      ...
      sender_id: 'user-4',
      content:
        'Great! I believe family is very important in a marriage. How do you envision your future family life?',
    ...
    },
    {
      ...
      sender_id: 'current-user',
      content:
        "I see a home centered around Islamic values, mutual respect, and open communication. I think it's important that both spouses support each other's goals while building a strong family foundation.",
