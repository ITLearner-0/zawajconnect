            ...
            <div className="flex items-start gap-4 flex-1">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-3 leading-relaxed">
                  Nous utilisons des cookies pour améliorer votre expérience sur ZawajConnect. Les
                  cookies essentiels sont nécessaires au fonctionnement de la plateforme
                  (authentification, sécurité). Vous pouvez choisir d'accepter ou de refuser les
                  cookies optionnels (analytiques pour améliorer nos services).
                </p>
                <a
                  href="/cookie-policy"
                  target="_blank"
