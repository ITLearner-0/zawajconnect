      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/80 mb-6 max-w-md leading-relaxed">
              Une plateforme matrimoniale moderne respectant les valeurs islamiques, où chaque union
              est bénie et guidée par les principes de la Shariah.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#valeurs" className="text-white/80 hover:text-white transition-colors">
                  Nos Valeurs
                </a>
              </li>
              <li>
                <a href="#processus" className="text-white/80 hover:text-white transition-colors">
                  Comment ça marche
                </a>
              </li>
              <li>
                <a href="#temoignages" className="text-white/80 hover:text-white transition-colors">
                  Témoignages
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 text-center space-y-2">
          <p className="text-white/60 text-xs">
            © {new Date().getFullYear()} ZawajConnect. Tous droits réservés. Plateforme
            matrimoniale conforme aux valeurs islamiques.
          </p>
          <p className="text-white/60 text-xs">
