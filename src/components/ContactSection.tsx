...
const ContactSection = () => {
  ...
  return (
    <section
      id="contact"
      className="py-20 px-4 bg-gradient-to-br from-cream via-sage/10 to-emerald/5"
    >
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16 animate-fade-in">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <h2 className="text-4xl font-bold text-foreground">Contactez-nous</h2>
          </div>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Une question, un conseil ou besoin d'aide ? Notre équipe dédiée est là pour vous
            accompagner dans votre recherche du partenaire idéal selon les valeurs islamiques.
          </p>
        </div>
            ...
            <Card className="shadow-elegant border-gold/20 bg-gradient-to-br from-gold/5 to-emerald/5">
              <CardContent className="p-6">
                <div className="text-center">
                  <h3 className="text-lg font-semibold text-foreground mb-3">Support Islamique</h3>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Notre équipe comprend l'importance des valeurs islamiques dans le processus de
                    mariage. Nous sommes là pour vous guider avec respect et bienveillance.
                  </p>
                  <div className="mt-4 p-3 bg-white/50 rounded-lg">
                    <p className="text-emerald-dark font-medium text-sm">
                      ...
                      viviez en tranquillité avec elles"
                    </p>
        ...
        <div className="mt-16 text-center animate-fade-in">
          <h3 className="text-xl font-semibold text-foreground mb-6">Questions fréquentes</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link to="/faq" className="block">
              <Button
                variant="outline"
                className="w-full h-auto p-4 text-left border-sage/30 hover:border-emerald"
              >
                <div>
