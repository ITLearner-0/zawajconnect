...
const MapContainer = forwardRef<MapContainerRef, MapContainerProps>(
  ({ profiles, userCoordinates, mapboxToken, showCompatibility, onNavigateToProfile }, ref) => {
    ...
    return <div ref={mapContainer} className="h-[400px] rounded-md overflow-hidden relative" />;
  }
);
