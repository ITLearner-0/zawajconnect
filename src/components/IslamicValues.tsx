...
const islamicValues: Value[] = [
  {
    ...
    description:
      "Le mariage est fondé sur l'amour mutuel, le respect et la compassion comme l'a enseigné notre bien-aimé Prophète ﷺ.",
    verse:
  ...
  },
  {
    ...
    description:
      "Nous priorisons la protection de votre intimité et le maintien des principes islamiques d'interaction modeste.",
    verse:
      'Le mariage représente la moitié de la foi, car il vous protège des péchés et vous aide à marcher sur le chemin de la droiture.',
  },
  {
    id: 3,
    ...
    description:
      'Nous encourageons la participation de la famille dans le processus matrimonial, suivant les traditions islamiques.',
    verse:
      "Quand quelqu'un dont vous êtes satisfait de la religion et du caractère vous demande en mariage, alors mariez-vous avec lui.",
  },
  {
    id: 4,
    ...
    description:
      "Accédez aux conseils islamiques authentiques sur le mariage, les relations et la vie familiale de la part d'érudits qualifiés.",
    verse:
      'Les meilleurs des gens sont ceux qui profitent aux autres, et le mariage est un moyen de se profiter mutuellement.',
  },
  {
    id: 5,
    ...
    description:
      "Chaque fonctionnalité est conçue avec les principes islamiques à l'esprit, vous aidant à trouver un partenaire de vie compatible.",
  ...
  },
  {
    ...
    description:
      'Notre processus de vérification garantit que vous vous connectez avec de véritables musulmans pratiquants cherchant le mariage.',
...
const IslamicValues = () => {
  return (
    <section
      id="valeurs"
      className="py-12 bg-gradient-to-br from-background via-sage/5 to-cream/10"
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ZawajConnect est plus qu'une simple plateforme matrimoniale. Nous sommes une communauté
            construite sur les beaux enseignements de l'Islam, aidant les musulmans à trouver leur
            partenaire parfait tout en maintenant les plus hauts standards de foi, de respect et de
            valeurs familiales.
          </p>
        </div>
            ...
            >
              <CardContent className="p-8">
                <div className="flex flex-col items-center text-center">
                  ...
                  {value.verse && (
                    <blockquote
                      className="text-sm text-emerald-600 font-medium italic text-center border-t border-emerald-100 pt-4 leading-relaxed animate-fade-in"
