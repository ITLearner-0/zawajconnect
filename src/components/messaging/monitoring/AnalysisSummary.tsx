    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-4 text-sm">
        ...
        <div>
          ...
          <p
            className={`font-medium ${
              (report.behavioralScore + report.islamicComplianceScore + report.sentimentScore) /
                3 >=
              80
                ? 'text-green-600'
                : (report.behavioralScore + report.islamicComplianceScore + report.sentimentScore) /
          ...
          >
            {Math.round(
              (report.behavioralScore + report.islamicComplianceScore + report.sentimentScore) / 3
            )}
            %
          </p>
        </div>
