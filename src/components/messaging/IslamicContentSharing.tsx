...
const SAMPLE_VERSES: IslamicContent[] = [
  {
    ...
    translation: 'Et parmi Ses signes Il a créé de vous, pour vous, des épouses pour que vous viviez en tranquillité avec elles et Il a mis entre vous de l\'affection et de la bonté.',
  ...
  },
  {
    ...
    translation: 'Le meilleur d\'entre vous est celui qui se comporte le mieux avec sa famille, et je suis le meilleur d\'entre vous avec ma famille.',
...
const IslamicContentSharing: React.FC<IslamicContentSharingProps> = ({ onShareContent }) => {
  ...
  const filteredContent = SAMPLE_VERSES.filter(content =>
          ...
          <TabsContent value="custom" className="space-y-4">
            <div className="space-y-3">
              ...
              <Button 
                ...
                disabled={!customContent.arabic || !customContent.translation || !customContent.reference}
                className="w-full"
              >
