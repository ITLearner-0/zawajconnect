      ...
      <CardContent>
        ...
        <div className="grid grid-cols-1 gap-2">
          ...
          >
            ...
            {isSubmitting && emergencyType === 'inappropriate_content' ? 'Reporting...' : 'Report Inappropriate Content'}
          </Button>
          ...
          >
            ...
            {isSubmitting && emergencyType === 'immediate_threat' ? 'Activating...' : 'Immediate Threat - Notify Admin'}
          </Button>
        </div>
      </CardContent>
    </Card>
