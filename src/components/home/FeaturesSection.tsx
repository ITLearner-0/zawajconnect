      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-rose-600 dark:text-rose-300 max-w-3xl mx-auto leading-relaxed">
            Des outils pensés pour respecter vos valeurs tout en facilitant des rencontres
            authentiques et sérieuses.
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="flex items-start gap-6">
                <div
                  className={`bg-gradient-to-br ${feature.color} p-4 rounded-2xl shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                >
                ...
                <div className="flex-1">
                  ...
                  <ul className="space-y-2">
                    {feature.benefits.map((benefit, benefitIndex) => (
                      <li
                        key={benefitIndex}
                        className="flex items-center gap-2 text-sm text-rose-700 dark:text-rose-300"
                      >
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-rose-600 dark:text-rose-400">{feature.description}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-rose-100 to-pink-100 dark:from-rose-900/50 dark:to-pink-900/50 rounded-2xl p-8 border border-rose-200 dark:border-rose-700 max-w-2xl mx-auto">
            ...
            <p className="text-rose-600 dark:text-rose-300 mb-6">
              Rejoignez des milliers de musulmans qui ont trouvé leur moitié grâce à notre
              plateforme.
            </p>
