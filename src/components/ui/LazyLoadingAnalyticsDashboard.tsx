                  ...
                  <Card className="p-3">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold">{formatDuration(metrics.averageLoadTime)}</p>
                      </div>
                  ...
                  <Card className="p-3">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold">{formatPercentage(metrics.cacheHitRate)}</p>
                      </div>
                        ...
                        <LineChart data={performanceData}>
                          ...
                          <Tooltip 
                            formatter={(value: number, name: string) => [
                              name === 'loadTime' ? formatDuration(value) : formatPercentage(value),
