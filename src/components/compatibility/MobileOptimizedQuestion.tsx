...
const MobileOptimizedQuestion = ({
  ...
  const currentLevel =
    ...
    agreementLevels[2];
  const categoryColor =
    compatibilityTranslations.categories[
      question.category as keyof typeof compatibilityTranslations.categories
    ] || question.category;
    ...
    <TooltipProvider>
      <div className="space-y-4 md:space-y-6">
        ...
        <div className="text-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
          <div
            className={`text-lg md:text-xl font-bold ${currentLevel?.color ?? 'bg-gray-400'} ${currentLevel?.textColor ?? 'text-white'} inline-block px-3 py-1 rounded`}
          >
