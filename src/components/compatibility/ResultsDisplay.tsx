  ...
  const getScoreMessage = (score: number) => {
    if (score >= 90)
      return {
        ...
        description:
          "Masha'Allah ! Vous avez d'excellentes bases pour un mariage béni selon les principes islamiques.",
        advice:
          "Continuez à cultiver ces valeurs communes et cherchez la bénédiction d'Allah dans votre union.",
      };
    if (score >= 80)
      return {
        title: 'Très bonne compatibilité',
        description:
          'Alhamdulillah ! Vous partagez des valeurs islamiques solides avec quelques points à approfondir.',
        advice:
          'Discutez ouvertement des quelques différences pour renforcer votre compréhension mutuelle.',
      };
    if (score >= 70)
      return {
        ...
        advice:
          "Prenez le temps d'échanger sur vos différences et cherchez des conseils auprès de personnes sages.",
      };
    if (score >= 60)
      return {
        title: 'Compatibilité moyenne',
        description:
          'Il existe des différences importantes qui nécessitent une réflexion sérieuse.',
    ...
    return {
      ...
      advice:
        'Consultez des guides spirituels et prenez le temps nécessaire avant de prendre une décision.',
    };
  };
    ...
    <div className="text-center space-y-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-700">
        ...
        <p className="text-sm text-blue-700 dark:text-blue-300 mb-4">
          Explorez maintenant des profils avec des pourcentages de compatibilité basés sur vos
          valeurs islamiques partagées.
        </p>
      ...
      <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-lg border border-emerald-200 dark:border-emerald-700">
        ...
        <p className="text-sm text-emerald-700 dark:text-emerald-300 italic">
          ...
          tranquillité avec elles et Il a mis entre vous de l'affection et de la bonté." - Coran
          30:21
        </p>
      </div>
