      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Une plateforme matrimoniale moderne qui honore les valeurs islamiques, où chaque
            rencontre est guidée par la Niyyah et le respect mutuel.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center p-6 rounded-lg bg-card shadow-soft card-hover group">
              ...
              <p className="text-muted-foreground text-sm">
                Communication respectueuse selon les principes islamiques
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-lg bg-card shadow-soft card-hover group">
              ...
              <p className="text-muted-foreground text-sm">
                Respect du rôle du Wali et de la famille
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-lg bg-card shadow-soft card-hover group">
              ...
              <p className="text-muted-foreground text-sm">
                Uniquement pour le mariage halal et durable
              </p>
            </div>
          </div>
        </div>
