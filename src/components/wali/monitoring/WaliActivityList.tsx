      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle>Historique des actions</CardTitle>
            <CardDescription>
              {filteredActions.length} action{filteredActions.length > 1 ? 's' : ''} enregistrée
            ...
            <div className="space-y-4">
              {filteredActions.map((action) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`flex-shrink-0 h-10 w-10 rounded-full bg-background flex items-center justify-center`}
                    >
