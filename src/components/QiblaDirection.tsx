          ...
          {location ? (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="outline">{getDistance()} km de la Mecque</Badge>
              </div>
        ...
        <CardContent>
          <div className="relative w-64 h-64 mx-auto">
            ...
            <div className="absolute inset-0 border-4 border-primary/20 rounded-full">
                ...
                {[0, 90, 180, 270].map((degree) => (
                  <div
                    ...
                    style={{
                      ...
                      transform:
                        degree === 0 || degree === 180 ? 'translateX(-50%)' : 'translateY(-50%)',
                    }}
                  />
                ))}
              </div>
              ...
              {/* Direction Labels */}
              <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 font-bold text-primary">
                N
              </div>
              <div className="absolute top-1/2 -right-6 transform -translate-y-1/2 font-bold text-primary">
                E
              </div>
              <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 font-bold text-primary">
                S
              </div>
              <div className="absolute top-1/2 -left-6 transform -translate-y-1/2 font-bold text-primary">
                W
              </div>
          ...
          <div className="mt-6 space-y-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-primary">{Math.round(qiblaDirection)}°</div>
              <div className="text-sm text-muted-foreground">Direction de la Qibla</div>
            </div>
