...
interface LazyProfilePictureUploadProps {
  profile: DatabaseProfile;
  onPictureUpdate: (profileId: string, newImageUrl: string) => void;
}

const LazyProfilePictureUpload = ({ profile, onPictureUpdate }: LazyProfilePictureUploadProps) => {
    ...
    <div className="relative group">
      <Avatar className="h-12 w-12 ring-2 ring-offset-2 ring-islamic-teal/20 group-hover:opacity-80 transition-opacity">
        {profile.profile_picture ? (
          ...
          <AvatarFallback className="bg-islamic-teal text-white">
...
export default LazyProfilePictureUpload;
