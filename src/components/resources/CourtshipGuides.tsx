  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {guides.map(guide => (
          <Card key={guide.id} className="group h-full flex flex-col bg-white dark:bg-rose-900/50 border border-rose-200 dark:border-rose-700 shadow-lg hover:shadow-2xl transform transition-all duration-500 hover:-translate-y-2 rounded-2xl overflow-hidden">
            <CardHeader className="pb-4">
              <div className="flex justify-between items-start mb-3">
                ...
                {guide.readingTime && (
                  <Badge variant="outline" className="border-rose-300 text-rose-600 bg-rose-50 dark:border-rose-600 dark:text-rose-300 dark:bg-rose-900/30 flex items-center gap-1">
            ...
            <CardContent className="flex-grow space-y-4">
              ...
              <div className="flex flex-wrap gap-1">
                {guide.tags.slice(0, 3).map(tag => (
                  <Badge key={tag} variant="secondary" className="text-xs bg-gradient-to-r from-rose-100 to-pink-100 dark:from-rose-800 dark:to-pink-800 text-rose-700 dark:text-rose-200">
                    {tag}
                  </Badge>
                ))}
              </div>
            ...
            <div className="p-6 pt-0">
              ...
              >
                <Link to={`/resources/${guide.id}`} className="flex items-center justify-center gap-2">
