  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {featuredResources.map(resource => (
        <Card key={resource.id} className="group h-full flex flex-col bg-white dark:bg-rose-900/50 border border-rose-200 dark:border-rose-700 shadow-lg hover:shadow-2xl transform transition-all duration-500 hover:-translate-y-2 rounded-2xl overflow-hidden">
          ...
          <CardFooter className="pt-0 pb-6">
            ...
            >
              <Link to={`/resources/${resource.id}`} className="flex items-center justify-center gap-2">
