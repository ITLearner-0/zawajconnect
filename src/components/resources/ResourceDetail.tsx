        ...
        <div className="container mx-auto py-12 px-4">
          <Card className="bg-white/80 dark:bg-rose-900/80 backdrop-blur-sm border-rose-200 dark:border-rose-700">
            <CardContent className="pt-6">
              ...
              <Button
                variant="outline"
                className="mt-4 border-rose-300 text-rose-700 hover:bg-rose-100 dark:border-rose-600 dark:text-rose-300 dark:hover:bg-rose-800"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-25 to-rose-100 dark:from-rose-950 dark:via-rose-900 dark:to-pink-950">
      ...
      <div className="container mx-auto py-12 px-4 max-w-4xl">
        <Button
          variant="outline"
          className="mb-6 border-rose-300 text-rose-700 hover:bg-rose-100 dark:border-rose-600 dark:text-rose-300 dark:hover:bg-rose-800"
          onClick={() => navigate('/resources')}
        >
          <ChevronLeft className="mr-2 h-4 w-4" /> Retour aux ressources
        </Button>
        ...
        <Card className="bg-white/80 dark:bg-rose-900/80 backdrop-blur-sm border-rose-200 dark:border-rose-700">
          <CardHeader>
            ...
            <CardTitle className="text-3xl text-rose-800 dark:text-rose-200">
              {resource.title}
            </CardTitle>
            ...
            {resource.content ? (
              ...
              <div className="my-6">
                <Button
                  variant="outline"
                  asChild
                  className="border-rose-300 text-rose-700 hover:bg-rose-100 dark:border-rose-600 dark:text-rose-300 dark:hover:bg-rose-800"
                >
                  <a
                    href={resource.url}
                    target="_blank"
