    ...
    <Card className={className}>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="text-center">
          ...
          <Progress value={behaviorScore.overall} className="mt-2" />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <div className="text-xs text-muted-foreground">{behaviorScore.communication}/100</div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="text-xs text-muted-foreground">{behaviorScore.respect}/100</div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="text-xs text-muted-foreground">{behaviorScore.compliance}/100</div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="text-xs text-muted-foreground">{behaviorScore.trustworthiness}/100</div>
          </div>
        </div>
