...
const processSteps: ProcessStep[] = [
  {
    ...
    description:
      'Configurez votre profil détaillé avec les préférences islamiques et les informations familiales.',
    details: [
  ...
  },
  {
    ...
    description:
      'Complétez notre processus de vérification multi-étapes pour une communauté de confiance.',
    details: [
  ...
  },
  {
    ...
    description:
      'Utilisez nos filtres avancés pour trouver des matches compatibles basés sur des critères islamiques.',
    details: [
  ...
  },
  {
    ...
    description:
      'Montrez votre intérêt pour des profils qui correspondent à vos préférences de manière respectueuse.',
    details: [
  ...
  },
  {
    ...
    description:
      'Commencez des conversations significatives avec vos matches dans un environnement surveillé.',
    details: [
...
const ProcessSection = () => {
  return (
    <section
      id="processus"
      className="py-12 bg-gradient-to-br from-cream/10 via-background to-sage/5"
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Suivez notre approche islamique pour trouver votre partenaire de vie. Chaque étape est
            conçue avec respect, confidentialité et valeurs islamiques au cœur.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-emerald-50 to-sage-50 rounded-2xl p-8 border border-emerald-200 max-w-4xl mx-auto">
            ...
            <p className="text-emerald-600 mb-6">
              Rejoignez des milliers de musulmans qui ont trouvé leurs partenaires de vie grâce à
              notre plateforme.
            </p>
            <Button
              size="lg"
