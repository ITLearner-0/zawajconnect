      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="mb-8 bg-gradient-to-r from-emerald/10 to-gold/10 border-emerald/30">
          <CardContent className="p-6">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              à une transparence totale sur nos conditions de remboursement, conformément aux
              principes islamiques de justice (Adl) et de compassion (Rahma).
            </p>
            <div className="p-4 bg-emerald/10 border border-emerald/20 rounded-lg">
              <p className="text-sm italic text-emerald-dark">
                "Et si le débiteur est dans la gêne, accordez-lui un sursis jusqu'à ce qu'il soit
                dans l'aisance. Mais il est mieux pour vous de faire preuve de charité, si vous
                saviez !"
        ...
        <div className="space-y-8">
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Notre engagement prioritaire envers vous
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <div className="p-4 bg-gold/10 border border-gold/30 rounded-lg">
                  ...
                  <p>
                    Si vous demandez un remboursement dans les <strong>7 premiers jours</strong>{' '}
                    suivant votre paiement initial, vous recevrez un{' '}
                    <strong>remboursement intégral à 100%</strong>, sans aucune justification
                    demandée.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <ol className="list-decimal list-inside space-y-2 ml-4">
                    ...
                    <li>
                      Objet : "Demande de remboursement - [Votre User ID ou email d'inscription]"
                    </li>
                    <li>
                      Indiquez la raison (optionnel mais apprécié pour améliorer notre service)
                    </li>
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <div className="p-4 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/30 rounded-lg">
                  ...
                  <p className="text-amber-800 dark:text-amber-300 text-sm">
                    Ce droit s'applique uniquement si le service n'a pas été utilisé de manière
                    substantielle. Si vous avez consulté <strong>plus de 20 profils</strong> ou
                    envoyé des messages, le service est considéré comme "utilisé" et le droit de
                    rétractation ne s'applique plus.
                  </p>
                </div>

                <p className="text-sm">
                  Dans ce cas, la <strong>Garantie Satisfait ou Remboursé de 7 jours</strong>{' '}
                  (Section 1) reste votre meilleure option.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-4 text-emerald">
                Remboursement Prorata (Cas Exceptionnels)
              </h2>
              <div className="space-y-3 text-muted-foreground">
                <p className="font-semibold text-foreground">Situations éligibles :</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
                    <strong>Problème technique majeur</strong> imputable à ZawajConnect (panne de
                    service {'>'}48h)
                  </li>
                  <li>
                    <strong>Suspension injustifiée</strong> de votre compte (après vérification par
                    nos équipes)
                  </li>
                  <li>
                    <strong>Fonctionnalité premium non accessible</strong> pendant plus de 7 jours
                    consécutifs
                  </li>
                </ul>
                ...
                <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/30 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800 dark:text-blue-300">
                    Le remboursement est calculé proportionnellement au temps restant de votre
                    abonnement.
                  </p>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-red-600 dark:text-red-400">
                    Cas où le Remboursement N'est PAS Possible
                  </h2>
                  <p className="text-sm text-muted-foreground">
                    Pour prévenir les abus et garantir l'équité
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 text-muted-foreground">
                <div className="space-y-2">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">
                        Après les 7 premiers jours d'abonnement actif
                      </p>
                      <p className="text-sm">
                        Une fois la période de garantie écoulée, aucun remboursement n'est possible
                        sauf cas exceptionnels (Section 3)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">
                        Utilisation intensive du service
                      </p>
                      <p className="text-sm">
                        Si vous avez consulté plus de 20 profils détaillés ou envoyé des messages
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">
                        Bannissement pour non-respect des règles de modération
                      </p>
                      <p className="text-sm">
                        Si votre compte a été banni pour violation grave de notre Charte
                        Communautaire
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">
                        Abonnements de plus d'un mois déjà utilisés
                      </p>
                      <p className="text-sm">
                        Seule la période restante peut être éligible au remboursement prorata
                        (Section 3)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">
                        Demande de remboursement frauduleuse
                      </p>
                      <p className="text-sm">
                        Toute tentative de fraude entraîne le rejet de la demande et le bannissement
                        du compte
                      </p>
                    </div>
                  </div>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-muted-foreground">
                <div className="p-4 bg-emerald/5 border border-emerald/20 rounded-lg">
                  ...
                  <ol className="list-decimal list-inside space-y-3 ml-2">
                    <li>
                      ...
                      <a
                        href="mailto:contact@zawajconnect.me"
                        className="text-emerald hover:underline ml-2 font-semibold"
                      >
                        contact@zawajconnect.me
                      </a>
                    </li>
                    <li>
                      <strong>Objet :</strong> "Demande de remboursement - [Votre User ID ou email
                      d'inscription]"
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Pièce jointe :</strong> Copie de la confirmation de paiement Stripe
                      (si disponible)
                    </li>
                  </ol>
                </div>
                ...
                <div className="p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/30 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800 dark:text-blue-300">
                    Nous examinerons votre demande sous 2-3 jours ouvrables. Vous recevrez un email
                    de confirmation avec :
                  </p>
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-4 text-emerald">
                Annulation d'Abonnement (Sans Remboursement)
              </h2>
              <div className="space-y-3 text-muted-foreground">
                <p>
                  Vous pouvez <strong>annuler votre abonnement à tout moment</strong> via le portail
                  de gestion Stripe.
                </p>
                ...
                <div className="p-4 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/30 rounded-lg">
                  ...
                  <ul className="text-sm text-amber-800 dark:text-amber-300 space-y-2">
                    <li>
                      • Votre service reste <strong>actif jusqu'à la fin du mois en cours</strong>
                    </li>
                    <li>
                      • <strong>Pas de remboursement</strong> pour le mois déjà payé
                    </li>
                    <li>
                      • <strong>Pas de renouvellement</strong> après la fin de votre engagement (3,
                      6 ou 12 mois)
                    </li>
                  </ul>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <ol className="list-decimal list-inside space-y-2 ml-4">
                    ...
                    <li>
                      Allez dans : Paramètres {'>'} Premium {'>'} Gérer mon abonnement
                    </li>
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-4 text-emerald">
                Remboursements en Cas de Problème Technique
              </h2>
              <div className="space-y-3 text-muted-foreground">
                <p>
                  Nous nous engageons à maintenir un service de qualité. En cas de problème
                  technique majeur imputable à ZawajConnect :
                </p>

                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
                    <strong>Panne de service {'>'}48h :</strong> Remboursement automatique
                    proportionnel
                  </li>
                  <li>
                    <strong>Fonctionnalité premium indisponible {'>'}7 jours :</strong>{' '}
                    Remboursement partiel
                  </li>
                  <li>
                    <strong>Notification proactive :</strong> Nous vous contactons en cas de
                    problème majeur
                  </li>
                </ul>

                <p className="text-sm italic">
                  Notre équipe technique surveille la plateforme 24/7 pour garantir une
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p>
                  Pour garantir l'équité envers tous nos utilisateurs, nous avons mis en place un
                  système de détection des demandes frauduleuses.
                </p>
                ...
                <div className="p-4 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/30 rounded-lg">
                  ...
                  <p className="text-sm text-red-800 dark:text-red-300">
                    Maximum <strong>2 remboursements</strong> par utilisateur sur une période de 12
                    mois. En cas d'abus répété (tentatives frauduleuses, fausses déclarations), le
                    compte sera
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-4 text-emerald">
                Conformité et Sécurité Stripe
              </h2>
              <div className="space-y-3 text-muted-foreground">
                <p>
                  Tous les remboursements sont traités via <strong>Stripe</strong>, notre processeur
                  de paiement sécurisé et certifié PCI-DSS.
                </p>

                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
                    Le remboursement apparaîtra sur votre relevé bancaire sous "ZawajConnect -
                    Remboursement"
                  </li>
        ...
        <Card className="mt-12 bg-gradient-to-r from-emerald/10 to-gold/10 border-emerald/30">
          <CardContent className="p-8 text-center">
            <p className="text-lg italic text-muted-foreground mb-4">
              "Et si le débiteur est dans la gêne, accordez-lui un sursis jusqu'à ce qu'il soit dans
              l'aisance. Mais il est mieux pour vous de faire preuve de charité, si vous saviez !"
            </p>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
                Nous nous engageons à traiter chaque demande de remboursement avec justice (Adl) et
                compassion (Rahma), conformément aux valeurs islamiques qui fondent notre
                plateforme.
              </p>
            </div>
          </CardContent>
        ...
        <Card className="mt-8 border-gold/30">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-2">Réponse sous 48-72h ouvrables</p>
          </CardContent>
        </Card>
