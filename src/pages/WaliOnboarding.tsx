          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Consultez et approuvez les profils potentiels</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Validez les correspondances avant toute communication</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Soyez informé de toutes les activités importantes</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Accompagnez selon les principes islamiques</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <p className="text-xs text-center text-muted-foreground">
                En continuant, vous acceptez de superviser les interactions matrimoniales selon les principes islamiques de respect et de guidance.
              </p>
            </form>
          </CardContent>
        </Card>
