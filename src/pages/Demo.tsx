...
import { Users, MessageSquare, Heart, BookOpen, Play, Shield, Star, Zap } from 'lucide-react';
  ...
  const demoFeatures = [
    {
      ...
      description:
        '4 personas soigneusement créés pour représenter la diversité de notre communauté',
      ...
      <div className="container mx-auto py-6">
        ...
        <div className="text-center mb-8 mt-6">
          ...
          <p className="text-xl text-rose-600 dark:text-rose-300 mb-6 max-w-3xl mx-auto">
            Explorez toutes les fonctionnalités de notre plateforme de mariage islamique dans un
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {demoFeatures.map((feature, index) => (
            <Card
              key={feature.title}
              className="group hover:shadow-lg transition-all duration-300 border-rose-200 dark:border-rose-700"
            >
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="overview">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="bg-white/80 dark:bg-rose-900/80 backdrop-blur-sm border-rose-200 dark:border-rose-700">
                <CardHeader>
                  <CardTitle className="text-rose-800 dark:text-rose-200 flex items-center gap-2">
                    <BookOpen className="h-5 w-5" />À propos de cette démonstration
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <p className="text-rose-600 dark:text-rose-300">
                    Cette démonstration vous permet d'explorer toutes les fonctionnalités de notre
                    plateforme sans créer de compte. Toutes les données sont fictives et créées
              ...
              <Card className="bg-white/80 dark:bg-rose-900/80 backdrop-blur-sm border-rose-200 dark:border-rose-700">
                ...
                <CardContent className="space-y-4">
                  <p className="text-rose-600 dark:text-rose-300">
                    Nous recommandons de commencer par le tutoriel interactif pour une expérience
                    guidée, ou d'explorer librement les différents onglets.
                  </p>
          ...
          <TabsContent value="profiles">
            <ProfileList profiles={demoPersonas} onSelectProfile={handleSelectProfile} />
          </TabsContent>
