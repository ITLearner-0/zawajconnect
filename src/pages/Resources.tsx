      ...
      <div className="container mx-auto py-12 px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-rose-600 dark:text-rose-300 max-w-3xl mx-auto">
            Ressources complètes pour un mariage islamique réussi : articles, guides pratiques et réponses à vos questions
          </p>
        </div>
        ...
        <Tabs defaultValue="articles" className="w-full">
          <TabsList className="grid w-full grid-cols-3 mb-8 bg-white/80 dark:bg-rose-900/80 backdrop-blur-sm border border-rose-200 dark:border-rose-700">
            <TabsTrigger value="articles" className="data-[state=active]:bg-rose-100 data-[state=active]:text-rose-700 dark:data-[state=active]:bg-rose-800 dark:data-[state=active]:text-rose-200">
              Articles & Livres
            </TabsTrigger>
            <TabsTrigger value="guides" className="data-[state=active]:bg-rose-100 data-[state=active]:text-rose-700 dark:data-[state=active]:bg-rose-800 dark:data-[state=active]:text-rose-200">
              Guides Pratiques
            </TabsTrigger>
            <TabsTrigger value="faq" className="data-[state=active]:bg-rose-100 data-[state=active]:text-rose-700 dark:data-[state=active]:bg-rose-800 dark:data-[state=active]:text-rose-200">
              FAQ Fiqh
            </TabsTrigger>
          </TabsList>
