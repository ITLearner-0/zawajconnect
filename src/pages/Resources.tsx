...
const Resources: React.FC = () => {
  ...
  if (resourceId) {
    ...
    if (!resource) {
      return (
        <div className="container mx-auto py-12 px-4 min-h-screen bg-gradient-to-br from-rose-50 via-pink-25 to-rose-100 dark:from-rose-950 dark:via-rose-900 dark:to-pink-950">
    ...
    return (
      <div className="container mx-auto py-12 px-4 max-w-4xl min-h-screen bg-gradient-to-br from-rose-50 via-pink-25 to-rose-100 dark:from-rose-950 dark:via-rose-900 dark:to-pink-950">
