            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ZawajConnect s'engage à respecter les valeurs islamiques de pudeur (Haya), respect
                  (Ihtiram) et confiance (Amana). Notre plateforme vise à faciliter des unions halal
                  et durables dans le respect de la Shariah.
                </p>
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p>
                  <strong>Plateforme :</strong> Le site web et l'application ZawajConnect accessible
                  via zawajconnect.me
                </p>
                <p>
                  <strong>Utilisateur :</strong> Toute personne inscrite et utilisant les services
                  de ZawajConnect
                </p>
                <p>
                  <strong>Wali :</strong> Tuteur légal ou familial désigné par l'utilisatrice pour
                  superviser sa démarche matrimoniale
                </p>
                <p>
                  <strong>Contenu :</strong> Toute information, texte, photo, ou donnée partagée sur
                  la plateforme
                </p>
                <p>
                  <strong>Services :</strong> L'ensemble des fonctionnalités offertes par
                  ZawajConnect pour faciliter les rencontres matrimoniales
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg dark:bg-amber-950/20 dark:border-amber-900/30">
                  ...
                  <p className="text-amber-800 dark:text-amber-300 mt-2">
                    L'utilisation de cette plateforme à des fins de rencontres occasionnelles, de
                    relations non-matrimoniales ou contraires aux principes islamiques est
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li className="font-semibold">
                    Avoir au moins <span className="text-emerald">18 ans révolus</span> (obligation
                    légale)
                  </li>
                  <li>Avoir une intention matrimoniale sérieuse et sincère</li>
                  <li>Vous engager à respecter les valeurs islamiques</li>
                  <li>
                    Accepter le système de supervision familiale (Wali) si vous êtes une femme
                  </li>
                  <li>Ne pas créer de faux profil ou usurper l'identité d'autrui</li>
                </ul>
                <p className="text-sm italic mt-4">
                  La création de compte implique l'acceptation de ces conditions et l'engagement à
                  n'utiliser la plateforme que dans un objectif matrimonial halal.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p>
                  <strong>4.1 Création du compte</strong>
                </p>
                <p>
                  Lors de votre inscription, vous devez fournir des informations véridiques, exactes
                  et à jour concernant votre identité, âge, situation personnelle et objectifs
                  matrimoniaux.
                </p>

                <p className="mt-4">
                  <strong>4.2 Vérification d'identité</strong>
                </p>
                <p>ZawajConnect propose trois niveaux de vérification :</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
                    <strong>Basique (65 points) :</strong> Vérification email uniquement
                  </li>
                  <li>
                    <strong>Enhanced (85 points) :</strong> Email + Téléphone + Photo (requis pour
                    la messagerie)
                  </li>
                  <li>
                    <strong>Ultra (100 points) :</strong> Email + Téléphone + Photo + Pièce
                    d'identité + Validation familiale
                  </li>
                </ul>

                <p className="mt-4">
                  <strong>4.3 Responsabilité de l'utilisateur</strong>
                </p>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    Informer immédiatement ZawajConnect en cas d'utilisation non autorisée de votre
                    compte
                  </li>
                </ul>

                <p className="mt-4">
                  <strong>4.4 Droit de suspension</strong>
                </p>
                <p>
                  ZawajConnect se réserve le droit de suspendre ou supprimer tout compte en cas de
                  doute sur l'authenticité des informations, de comportement inapproprié ou de
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p className="font-semibold text-foreground">
                  Le système Wali est une spécificité unique de ZawajConnect qui distingue notre
                  plateforme des services de dating classiques.
                </p>

                <p>
                  <strong>5.1 Obligation pour les utilisatrices musulmanes</strong>
                </p>
                <p>
                ...
                <p className="mt-4">
                  <strong>5.2 Rôle et responsabilités du Wali</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p className="mt-4">
                  <strong>5.3 Processus d'invitation et d'acceptation</strong>
                </p>
                ...
                <p className="mt-4">
                  <strong>5.4 Droits du Wali</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p className="mt-4">
                  <strong>5.5 Protection de l'utilisatrice</strong>
                </p>
                <div className="p-4 bg-emerald/10 border border-emerald/20 rounded-lg">
                  ...
                  <p className="mt-2">
                    Le Wali doit agir dans l'intérêt supérieur de l'utilisatrice, conformément aux
                    principes islamiques de bienveillance et de protection. Tout abus de pouvoir ou
                    comportement inapproprié du Wali peut être signalé à ZawajConnect pour révision.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-4 text-emerald">
                Article 6 - Conduite des Utilisateurs
              </h2>
              <div className="space-y-3 text-muted-foreground">
                <p>
                  <strong>6.1 Comportements obligatoires</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p className="mt-4">
                  <strong>6.2 Comportements strictement interdits</strong>
                </p>
                <div className="space-y-2 ml-4">
                  ...
                  <p className="flex items-start gap-2">
                    <span className="text-red-500 font-bold">❌</span>
                    <span>
                      Partage d'informations personnelles (numéro, adresse) avant approbation du
                      Wali
                    </span>
                  </p>
                  <p className="flex items-start gap-2">
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-3 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/30 rounded">
                    <p className="font-semibold text-red-900 dark:text-red-200">
                      3ème infraction : Bannissement définitif
                    </p>
          ...
          <Card className="border-gold/30">
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-4 text-emerald">
                Article 7 - Modération et Sécurité
              </h2>
              <div className="space-y-3 text-muted-foreground">
                <p className="font-semibold text-foreground">
                  ZawajConnect utilise un système de modération à deux niveaux pour garantir un
                  environnement sûr et respectueux des valeurs islamiques.
                </p>

                <p>
                  <strong>7.1 Modération IA en temps réel (95% de précision)</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p className="mt-4">
                  <strong>7.2 Modération humaine</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p className="mt-4">
                  <strong>7.3 Transparence</strong>
                </p>
                <p>
                  La raison précise de la modération est toujours communiquée à l'utilisateur, avec
                  référence à l'article des CGU violé.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-gold/30">
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-4 text-emerald">
                Article 8 - Abonnements et Tarification
              </h2>
              <div className="space-y-3 text-muted-foreground">
                <p>
                  <strong>8.1 Offre Freemium (Gratuite)</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p className="text-sm italic">
                  Limitations : Pas de messagerie, pas de likes, pas de matches
                </p>

                <p className="mt-4">
                  <strong>8.2 Offres Premium (Prix Hors Taxes)</strong>
                </p>
                ...
                <p className="mt-4">
                  <strong>8.3 Modalités de paiement</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    Annulation possible à tout moment (service actif jusqu'à fin du mois payé)
                  </li>
                </ul>
                ...
                <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/30 rounded-lg">
                  <p className="font-semibold text-blue-900 dark:text-blue-200">
                    ...
                    <Link to="/refund-policy" className="text-blue-600 hover:underline ml-1">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p>
                  ZawajConnect offre une <strong>garantie satisfait ou remboursé de 7 jours</strong>{' '}
                  ainsi qu'un
                  <strong> droit de rétractation légal de 14 jours</strong> conformément à la loi
                  française sur la vente à distance.
                </p>
                <p>
                  Pour tous les détails sur les conditions de remboursement, les cas d'exclusion et
                  la procédure à suivre, veuillez consulter notre
                  <Link
                    to="/refund-policy"
                    className="text-emerald hover:underline ml-1 font-semibold"
                  >
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p>
                  <strong>10.1 Photos et contenus uploadés</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p className="mt-4">
                  <strong>10.2 Marque et logo ZawajConnect</strong>
                </p>
                <p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p>
                  ZawajConnect est pleinement conforme au Règlement Général sur la Protection des
                  Données (RGPD - UE 2016/679).
                </p>

                <p>
                  <strong>11.1 Responsable de traitement</strong>
                </p>
                <p>contact@zawajconnect.me</p>

                <p>
                  <strong>11.2 Données collectées</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p>
                  <strong>11.3 Finalités du traitement</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p>
                  <strong>11.4 Durée de conservation</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p>
                  <strong>11.5 Vos droits (RGPD)</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p>
                  <strong>11.6 Exercice de vos droits</strong>
                </p>
                <p>
                  ...
                  avec un justificatif d'identité.
                </p>

                <p>
                  <strong>11.7 Réclamation</strong>
                </p>
                <p>
                  Vous pouvez saisir la CNIL (Commission Nationale de l'Informatique et des
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <p>
                  <strong>12.1 Ce que nous ne sommes PAS :</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p>
                  <strong>12.2 Responsabilité de l'utilisateur :</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p>
                  <strong>12.3 Exclusions de responsabilité :</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p>
                  <strong>12.4 Notre engagement :</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-4 text-emerald">
                Article 13 - Résiliation et Suppression du Compte
              </h2>
              <div className="space-y-3 text-muted-foreground">
                <p>
                  <strong>13.1 Résiliation par l'utilisateur</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>Droit de supprimer votre compte à tout moment</li>
                  <li>
                    Procédure : Paramètres {'>'} Sécurité {'>'} Supprimer mon compte
                  </li>
                ...
                <p>
                  <strong>13.2 Résiliation par ZawajConnect</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p>ZawajConnect se réserve le droit de modifier les présentes CGU à tout moment.</p>
                <p>
                  <strong>Notification obligatoire :</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>Notification par email 15 jours avant application</li>
                  <li>
                    Possibilité de refuser : vous devez supprimer votre compte dans les 15 jours
                  </li>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <p>
                  <strong>Juridiction compétente :</strong> Tribunaux de Paris
                </p>
                <p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <p>
                  <strong>Délai de réponse :</strong> 48-72 heures ouvrables
                </p>
        ...
        <Card className="mt-12 bg-gradient-to-r from-emerald/10 to-gold/10 border-emerald/30">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Qu'Allah bénisse tous nos utilisateurs dans leur recherche d'une union halal et
              durable - آمين
            </p>
          </CardContent>
        </Card>
