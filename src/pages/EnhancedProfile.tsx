...
const EnhancedProfile = () => {
  ...
  const [privacySettings, setPrivacySettings] = useState<PrivacySettingsData | undefined>(
    undefined
  );
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      toast({
        ...
        description:
          "Certaines données n'ont pas pu être chargées. Réessayez ou contactez le support.",
        variant: 'destructive',
      });
    }, 10000);
    ...
    try {
      ...
      if (verificationRes.error) {
        ...
        setVerification({
          ...
          verification_documents: (verificationRes.data.verification_documents ?? []).filter(
  ...
  const calculateCompletionStats = () => {
    ...
    if (islamicPrefs) {
      ...
      const halalDietCompleted =
        islamicPrefs.halal_diet !== null && islamicPrefs.halal_diet !== undefined ? 1 : 0;
      console.log(
        `📊 Field halal_diet: ${islamicPrefs.halal_diet} (completed: ${halalDietCompleted > 0})`
      );
      ...
      console.log(
        `📊 Islamic Prefs Score: ${totalCompleted}/${totalFields} = ${islamicPrefsScore}%`
      );
    } else {
    ...
    const overall =
      (basicInfo + islamicPrefsScore + photos + compatibility + privacyScore + verificationScore) /
      6;
  ...
  return (
    ...
    >
      {/* Header Section */}
      <motion.div variants={itemVariants} className="bg-card rounded-lg border p-6">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Badge variant="outline">{completionStats.overall}% Complété</Badge>
            </motion.div>
          </div>
        </div>
      </motion.div>
                  ...
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <VerificationBadge
                          verificationScore={verification?.verification_score || 0}
                        />
                      </div>
                          ...
                          <CardContent className="space-y-4">
                            ...
                            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                              ...
                              >
                                ...
                                {completionStats.compatibility >= 80
                                  ? 'Test complété'
                          ...
                          <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2">
                              <div className="flex justify-between text-sm">
                                ...
                                <Badge
                                  variant="outline"
                                  className={getCompletionColor(completionStats.overall)}
                                >
                                  {completionStats.overall >= 80
                                    ? 'Excellent'
                              ...
                              <div className="flex justify-between text-sm">
                                ...
                                <span className="text-muted-foreground">
                                  {compatibilityStats.answeredQuestions}/
                                  {compatibilityStats.totalQuestions} réponses
                                </span>
                              </div>
                              <div className="flex justify-between text-sm">
                            ...
                            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                              ...
                              >
                                ...
                                {completionStats.overall >= 60
                                  ? 'Voir mes Matches'
                                  : 'Complétez votre profil pour les matches'}
                              </Button>
                            </motion.div>
                          </CardContent>
                        </Card>
                        ...
                        <CardContent className="space-y-4">
                          <div className="space-y-4">
                            {[
                              ...
                              const percentage =
                                completionStats[key as keyof ProfileCompletionStats];
                              return (
                                <motion.div
                                  key={key}
                                  initial={{ opacity: 0, x: -20 }}
                        ...
                        <CardContent>
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            {completionStats.compatibility < 70 && (
                              ...
                              >
                                <h4 className="font-medium text-emerald mb-2">
                    ...
                    <EnhancedIslamicPreferences
                      ...
                      onComplete={() => {
                        ...
                        toast({
                          ...
                          description:
                            'Vos préférences islamiques ont été enregistrées avec succès',
                        });
                      }}
                    />
                  </motion.div>
      ...
      <ProfileChatbot profile={profile} completionStats={completionStats} />
    </motion.div>
  );
};
